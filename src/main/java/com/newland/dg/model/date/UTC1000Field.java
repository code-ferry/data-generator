 ...
 */
@ToString
public class UTC1000Field extends AbstractFieldInfo {
    private static final Logger logger = LoggerFactory.getLogger(UTC1000Field.class);
    ...
    public UTC1000Field() {
        super.type = FieldType.UTC1000.getName();
    }

    @Builder(toBuilder = true)
    public UTC1000Field(String startTime, String endTime) {
    ...
    protected String handle() {
        long l = RandomUtils.nextLong(lStartTime, lEndTime + 1000) / 1000;
